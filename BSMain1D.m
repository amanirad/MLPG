function [maxnrm,finnrm,xs,error,xls,res,time,timerror,timeres,ao,mem]= ...
      BSMain1D(phi,ep,M,N,Ns,rg,ctype,etype,method,show,col,Nls)
%
...
if (ls)
  ...
  if (strcmp(method{1},'dir'))
    [L2,U2,P2,L1,U1,P1,Cel,Cem,Abl,Abm,Ael,Aem,Esl,Esm]= ...
        BSMLMatrices(ir,sigma,beta0,phi,ep,xc,xb,xs);
